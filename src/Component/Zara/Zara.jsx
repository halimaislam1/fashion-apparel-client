        ...
        <SwiperSlide>
         {/* Slider-1 */}
          <div
            ...
            style={{ backgroundImage: "url(https://st-mina.myshopify.com/cdn/shop/t/13/assets/slideshow_image_1.jpg)" }}
          >
            <div className="ml-28">
              <div className="max-w-md mt-20">
                <h1 className="mb-5 text-2xl md:text-5xl text-white md:font-bold">Summer Sale</h1>
                ...
                <button className="btn md:text-xl ml-10 bg-amber-500 text-white ">30%OFF</button>
              </div>
            </div>
          </div>
        </SwiperSlide>
          ...
          >
            ...
            <div className="ml-52 md:ml-96 pl-0 lg:pl-72">
              <div className="max-w-md ">
                <h1 className="mb-5 text-2xl md:text-5xl font-bold">Man New Arrival</h1>
                <p className="mb-5 text-sm md:text-md">
                Discover the man new arrival fashion trends. The choice of materials and fabrics is crucial in dress collections. Designers select fabrics that suit the season and occasion.
                </p>
