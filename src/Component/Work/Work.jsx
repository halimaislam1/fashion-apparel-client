...
const Work = () => {
  return (
    <div className=" mb-20 ">
      <h1 className="text-center  text-5xl  font-bold mb-3 ">How We Work??</h1>
      ...
      <div className="max-w-6xl  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 ml-24 md:ml-40 md:gap-10  ">
        <div className="mb-8 md:mb-0">
          ...
          <p className=" ml-20 font-bold text-xl">Order</p>
        ...
        <div className="mb-8 md:mb-0">
          ...
          <p className=" ml-20  font-bold text-xl">Delivery</p>
         ...
         <div className="mb-8 md:mb-0">
            ...
            <p className="  ml-20  font-bold text-xl">Done</p>
